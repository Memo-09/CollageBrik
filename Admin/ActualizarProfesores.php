...
<body>
    ...
    <span class="Section-cards">
        <section class="card">
            ...
            ?>
            <form class="form-register" method ="POST" action ="Operacion_Actualiza2.php?clave=<?php echo $tabla[2]?>">
                <h4>Actualizar Profesores</h4>
                <label>Nombre</label>
                ...
                <label>CLave</label>
                <input class="controls" type="text" name="matricula" id="matricula" placeholder="Ingrese tú Matricula" disabled=true value=<?php echo $tabla[2]; ?> >
                <label>Correo</label>
                ...
                <option selected value=<?php echo $tabla[5] ?>><?php echo $tabla[6] ?></option>
                <?php 
                ...
                ?>
                <input class="botons" type="submit" name="profesor" value="Actualizar">
            </form>
        </section>
    </span>
