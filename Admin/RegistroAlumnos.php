    ...
    <span class="Section-cards">
        <section class="card">
            <form class="form-register" method ="POST" >
                ...
                <input href ="registro.php" class="botons" name="alumnos" type="submit" value="Registrar">
                <?php 
                ...
                ?>
                            <script>
                                alert("Falta elementos por llenar");
                            </script>
                <?php
                        }else{
                ...
                <?php
                                ...
                                echo "<center>Las contraseñas son incorrecta</center>";
                            }
                        }
                    }
                ?>
